...
const FilterDropdown: React.FC<FilterDropdownProps> = ({ onFilterChange }) => {
  ...
  return (
    <div className="relative w-[150px]" onMouseLeave={closeDropdown}>
      <div
        className="text-xs text-[#2b3034e6] font-Averta-Bold gap-4 flex items-center justify-between border border-solid border-[#d5d5d5] bg-[#fcfdfd] rounded-lg h-[38px] px-2 lg:px-4 cursor-pointer w-full"
