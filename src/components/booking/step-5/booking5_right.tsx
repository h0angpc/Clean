    ...
    <div className="w-full min-w-[365px] md:w-1/3 p-4 bg-gray-100 min-h-screen">
      ...
      <div className="flex mt-[40px]">
        <Input
          ...
          className="bg-white border-gray-300 h-[50px] font-Averta-Regular"
        />
        <Button className="bg-[#1A78F2] h-[50px] md:w-1/3 ml-[8px] font-Averta-Semibold text-[16px]">
          Apply
        </Button>
      </div>
        ...
        <div className="p-6 bg-white rounded-lg">
          <div className="mb-4 flex justify-between items-center">
            <div className="flex">
              ...
              <p className="text-blue-600 font-Averta-Semibold ml-[10px]">
                - Details
              </p>
            </div>
