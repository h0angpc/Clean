  ...
  return (
    <div
      ...
      <div className={`flex flex-col lg:flex-[2] grow shrink justify-center pl-2.5 text-sm font-bold text-neutral-800 w-full lg:w-[70px]`}>
        <div className="overflow-hidden self-stretch px-3 lg:py-4 py-2 w-full  font-Averta-Bold text-[14px]">{helper?.user?.fullName}</div>
      </div>
      ...
      <div className={`flex flex-col lg:flex-[5] grow shrink justify-center pl-2.5 text-sm font-semibold  text-neutral-800 lg:w-[500px] w-full`}>
        <div className="overflow-hidden self-stretch px-3 lg:py-4 py-2 w-full lg:min-w-[200px] font-Averta-Bold text-[14px]">{requestReason}</div>
      </div>
